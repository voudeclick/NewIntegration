...
namespace VDC.Integration.WebApi.ViewModels.TenantData
{
    ...
    public static class OmieDataViewModelExtensions
    {
        public static void UpdateFrom(this OmieData entity, OmieDataViewModel viewModel)
        {
            ...
            entity.SetCodigoParcelasMapping(viewModel.CodigoParcelaMappings?.Select(x => new OmieCodigoParcelaMapping
            {
                CodigoParcelaOmie = x.CodigoParcelaOmie,
                QuantidadeParcela = x.QuantidadeParcela,
                QtdeDiasParaPagamento = x.QtdeDiasParaPagamento
            }).ToList());
