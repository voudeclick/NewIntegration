samuraiApp.controller('usersController', ['$scope', '$compile', 'userService', 'DTOptionsBuilder', 'DTColumnBuilder', function ($scope, $compile, userService, DTOptionsBuilder, DTColumnBuilder) {
    $scope.indexRoles=0;
    $scope.roles;
