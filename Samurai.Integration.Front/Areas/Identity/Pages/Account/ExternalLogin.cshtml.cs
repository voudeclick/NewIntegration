...
using Samurai.Integration.Identity.Services;

namespace Samurai.Integration.Front.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            {                
                ...
                if (email.Split('@').LastOrDefault() != "samuraiexperts.com.br")
                {
                    ErrorMessage = $"O domínio do e-mail deve pertencer a Samurai Experts.";
                    return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
                }
