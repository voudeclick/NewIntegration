var vdcApp = angular.module('vdcApp', ['datatables', 'datatables.buttons', 'ngScrollToError', 'ngTagsInput'])
...
vdcApp.config(['$httpProvider', InterceptorProvider]);

function InterceptorProvider($httpProvider) {
    $httpProvider.interceptors.push('Interceptor');
}

vdcApp.service('util', ['$rootScope', '$http', '$window', function ($rootScope, $http, $window) {
...
vdcApp.service('tenantService', ['$http', function ($http) {
...
vdcApp.service('omieService', ['$http', function ($http) {
...
vdcApp.service('queueService', ['$http', function ($http) {
...
vdcApp.directive('loadingButton', function ($compile) {
...
vdcApp.directive('convertToNumber', function () {
    return {
        require: 'ngModel',
