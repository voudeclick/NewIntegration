vdcApp.controller('tenantController', ['$scope', '$http', 'util', 'tenantService', 'omieService', 'queueService', 'shopifyService', function ($scope, $http, util, tenantService, omieService, queueService, shopifyService) {
