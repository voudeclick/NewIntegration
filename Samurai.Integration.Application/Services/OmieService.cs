...
using Samurai.Integration.APIClient.Omie.Models.Request.ClienteCadastro;
using Samurai.Integration.APIClient.Omie.Models.Request.ClienteCadastro.Inputs;
using Samurai.Integration.APIClient.Omie.Models.Request.ConsultaEstoque;
...
using Samurai.Integration.APIClient.Omie.Models.Request.PedidoVendaFaturamento;
...
using Samurai.Integration.APIClient.Omie.Models.Request.ProdutoCadastro;
...
namespace Samurai.Integration.Application.Services
{
    public class OmieService
    {
                                    ...
                                    CancellationToken cancellationToken = default)
        {
            ...
            {
                _logger.Warning("OmieService - Error in ListProduct | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), new ConsultarFamiliaOmieRequestInput
                {
                    codigo = familyId
                ...
                {
                    {
                        ...
                        do
                        {
                            ...
                            {
                                _logger.Warning("OmieService - Error in ListProduct | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), new ListarProdutosOmieRequestInput
                                {
                                    pagina = page,
                                    registros_por_pagina = 50,
                                    filtrar_apenas_marketplace = "S",
                    ...
                    foreach (var sku in productSkuList)
                    {
                        if (sku.inativo != "S")
                        {
                            ...
                            if (result.Result == Result.Error)
                            {
                                _logger.Warning("OmieService - Error in ListProduct | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), new PosicaoEstoqueOmieRequestInput
                                {
                                    id_prod = sku.codigo_produto,
                                    codigo_local_estoque = omieData.CodigoLocalEstoque
                                }, omieData), result.Error.Message);
        ...
        private ShopifyUpdateFullProductMessage GetFullProductMessage(OmieData omieData, ConsultarFamiliaOmieRequestOutput family, List<ProdutoCadastroResult> productSkuList, Dictionary<long, PosicaoEstoqueOmieRequestOutput> stockList)
        {
            ...
            if (omieData.Id == 71)
            {
                _logger.Warning("GetCategories:1 " + JsonConvert.SerializeObject(shopifyUpdateFullProductMessage.ProductInfo));
            }
        ...
        public async Task<ReturnMessage> ListPartialProduct(OmieListPartialProductMessage message, OmieData omieData, QueueClient shopifyPartialProductQueueClient, QueueClient shopifyPartialSkuQueueClient, CancellationToken cancellationToken)
        {
            ProdutoCadastroResult sku = null;
            {
                ...
                if (result.Result == Result.Error)
                {
                    _logger.Warning("OmieService - Error in ListPartialProduct | {0} | Error: {1}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), new ListarProdutosOmieRequestInput
                    {
                        registros_por_pagina = 1,
                        filtrar_apenas_marketplace = "S",
                        exibir_caracteristicas = "S",
        ...
        public async Task<ReturnMessage> ListStockSku(OmieListStockSkuMessage message, OmieData omieData, QueueClient shopifyStockQueueClient, CancellationToken cancellationToken)
        {
            ...
            if (result.Result == Result.Error)
            {
                _logger.Warning("OmieService - Error in  ListStockSku |Erro message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), new PosicaoEstoqueOmieRequestInput
                {
                    id_prod = message.ProductSkuId,
                    codigo_local_estoque = omieData.CodigoLocalEstoque
                }, omieData), result.Error.Message);
            ...
            try
            {
                ...
                if (currentData.Result == Result.Error)
                {
                    if (currentData.Error is OmieException)
                    {
                        ...
                        {
                            _logger.Warning("OmieService - Error in UpdateOrder | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), message, omieData));
                ...
                if (currentData.Data?.pedido_venda_produto == null)
                {
                    ...
                    message.Items.ForEach(i =>
                    {
                        ...
                        items.Add(new IncluirPedidoOmieRequestInput.Item
                        {
                            ...
                            produto = new IncluirPedidoOmieRequestInput.Produto
                            {
                                ...
                                valor_desconto = i.DiscountValue > 0 ? i.DiscountValue : (decimal?)null,
                    ...
                    if (order.Result == Result.Error)
                    {
                        ...
                        _logger.Warning("OmieService - Error in UpdateOrder | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), message, omieData), order?.Error?.Message);
                    ...
                    if (OrderResult?.Result == Result.Error)
                    {
                        ...
                        _logger.Warning("OmieService - Error in UpdateOrder | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), message, omieData), OrderResult?.Error?.Message);
                ...
                else
                {
                    ...
                    if (message.Cancelled)
                    {
                        if (currentOrder.infoCadastro?.cancelado != "S")
                        {
                            ...
                            {
                                _logger.Warning("OmieService - Error in UpdateOrder | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), message, omieData), cancelOrderResult.Error.Message);
                    ...
                    else if (message.Approved)
                    {
                                ...
                                && int.Parse(currentOrder.cabecalho.etapa) < int.Parse(omieData.CodigoEtapaPaymentConfirmed))
                        {
                            ...
                            {
                                _logger.Warning("OmieService - Error in UpdateOrder | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), message, omieData), setAsPaidOrderResult?.Error?.Message);
        ...
        private async Task<ReturnMessage<IncluirPedidoOmieRequestInput>> CreateOrderToOmie(OmieData omieData, ShopifySendOrderToERPMessage message, List<IncluirPedidoOmieRequestInput.Item> items, CancellationToken cancellationToken)
        {
            ...
            {
                _logger.Warning("OmieService - Error in CreateOrderToOmie | Erro message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), message, omieData), updateClientResult.Error.Message);
        ...
        private async Task<ReturnMessage<UpsertClienteOmieRequestOutput>> UpsertClienteOmie(OmieData omieData, ShopifySendOrderToERPMessage message, CancellationToken cancellationToken)
        {
            ...
            if (queryClient.Result == Result.Error)
            {
                if (queryClient.Error is OmieException)
                {
                    ...
                    if (omieError.IsError())
                    {
                        _logger.Warning("OmieService - Error in UpdateOrder | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), message, omieData), queryClient.Error.Message);
            ...
            if (updateClientResult.Result == Result.Error)
            {
                _logger.Warning("OmieService - Error in UpdateOrder | Erro message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), message, omieData), updateClientResult.Error.Message);
        ...
        public async Task<ReturnMessage> ListOrder(string externalOrderId, OmieData omieData, QueueClient shopifyUpdateOrderStatusQueueClient, CancellationToken cancellationToken)
        {
            ...
            if (!string.IsNullOrWhiteSpace(externalOrderId))
            {
                ...
                {
                    _logger.Warning("OmieService - Error in ListOrder | Error message: {1} | {0}", LoggingExtensions.FromService(LoggingExtensions.GetCurrentMethod(), new ConsultarPedidoOmieRequestInput
                    {
                        codigo_pedido_integracao = externalOrderId
