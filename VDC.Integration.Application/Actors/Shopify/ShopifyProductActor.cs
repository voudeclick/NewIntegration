            ...
            : base("ShopifyProductActor")
        {
            ...
            ReceiveAsync((Func<ShopifyUpdateFullProductMessage, Task>)(async message =>
            {
                try
                {
                    ...
                    {
                        LogError(ex, "ShopifyProductActor (ShopifyUpdatePartialProductMessage) - Problemas ao salvar alteração na integração de ShopifyUpdateFullProductMessage | {0}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null, $"Problemas ao salvar alteração na integração de preço | {ex.Message}"));
                    }
                    ...
                    if (shopifyData.EnableSaveIntegrationInformations)
                    {
                        ...
                        {
                            LogError(ex, $"ShopifyProductActor - Problemas ao salvar alteração na integração de ShopifyUpdateFullProductMessage | {ex.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null, $"Problemas ao salvar alteração na integração de preço"));
                        }
                    }
            ...
            ReceiveAsync((Func<ShopifyUpdatePartialProductMessage, Task>)(async message =>
            {
                try
                {
                    ...
                    {
                        LogError(ex, "ShopifyProductActor (ShopifyUpdatePartialProductMessage) - Problemas ao salvar alteração na integração de ShopifyUpdatePartialProductMessage | {0}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null, $"Problemas ao salvar alteração na integração de preço | {ex.Message}"));
                    }
                    ...
                    if (shopifyData.EnableSaveIntegrationInformations)
                    {
                        ...
                        {
                            LogError(ex, $"ShopifyProductActor - Problemas ao salvar alteração na integração de ShopifyUpdatePartialProductMessage | {ex.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null, $"Problemas ao salvar alteração na integração de preço"));
                        }
                    }
            ...
            ReceiveAsync((Func<ShopifyUpdatePriceMessage, Task>)(async message =>
            {
                try
                {
                    ...
                    {
                        LogError(ex, $"ShopifyProductActor - Problemas ao salvar alteração na integração de preço | {ex.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null, $"Problemas ao salvar alteração na integração de preço"));
                    }
            ...
            ReceiveAsync((Func<ShopifyUpdateStockMessage, Task>)(async message =>
            {
                try
                {
                    ...
                    {
                        LogWarning("ShopifyProductActor - Problemas ao salvar alteração na integração de stock | {0}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null, $"Problemas ao salvar alteração na integração de stock | {ex.Message}"));
                    }
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in ShopifyUpdateStockMessage", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<ShopifyUpdateProductKitMessage, Task>)(async message =>
             {
                 ...
                 {
                     LogError(ex, $"ShopifyProductActor - Error in ShopifyUpdateProductKitMessage", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                     Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                 }
             }));
            ...
            ReceiveAsync((Func<ShopifyUpdateStockKitMessage, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in ShopifyUpdateStockKitMessage", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<ShopifyUpdateProductImagesMessage, Task>)(async message =>
            {
                ...
                try
                {
                    ...
                    {
                        _log.Error($"Problemas ao salvar alteração na integração de imagem | {ex.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null, $"Problemas ao salvar alteração na integração de imagem"));
                    }
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        _log.Error($"Problemas ao salvar exception na integração de imagem | {exx.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null, $"Problemas ao salvar alteração na integração de imagem"));
                    }

                    LogError(ex, $"ShopifyProductActor - Error in ShopifyUpdateProductImagesMessage", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<ProductIdsByTagQuery, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in ProductIdsByTagQuery", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<ProductMetafieldsByTagQuery, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in ProductMetafieldsByTagQuery", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<AllProductsTagsQuery, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in AllProductsTagsQuery", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<AllCollectionsQuery, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in AllCollectionsQuery", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<CollectionCreateMutation, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in CollectionCreateMutation", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<ProductUpdateMutation, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in ProductUpdateMutation", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<ShopifyEnqueueListERPProductCategoriesMessage, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in ShopifyEnqueueListERPProductCategoriesMessage", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
            ...
            ReceiveAsync((Func<ShopifyEnqueueUpdatePartialProductMessage, Task>)(async message =>
            {
                ...
                {
                    LogError(ex, $"ShopifyProductActor - Error in ShopifyEnqueueUpdatePartialProductMessage", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, null));
                    Sender.Tell(new ReturnMessage { Result = Result.Error, Error = ex });
                }
            }));
