...
using VDC.Integration.APIClient.API.Models.Request;
using VDC.Integration.APIClient.API.Models.Result;
using VDC.Integration.APIClient.Millennium.Models.Requests;
using VDC.Integration.APIClient.Millennium.Models.Results;
using VDC.Integration.Application.Actors;
...
using VDC.Integration.Domain.Models.Millennium.Integration;
...
using static VDC.Integration.Domain.Models.Product;
...
namespace VDC.Integration.Application.Services
{
    public class MillenniumService
    {
        ...
        readonly MillenniumProductStockIntegrationRepository _millenniumProductStockIntegrationRepository;
        readonly MillenniumNewStockProcessRepository _millenniumNewStockProcessRepository;
        readonly MillenniumNewPricesProcessRepository _millenniumNewPricesProcessRepository;
        readonly MillenniumProductPriceIntegrationRepository _millenniumProductPriceIntegrationRepository;
        readonly MillenniumNewProductProcessRepository _millenniumNewProductProcessRepository;
        readonly MillenniumProductIntegrationRepository _millenniumProductIntegrationRepository;
        readonly MillenniumUpdateOrderProcessRepository _millenniumUpdateOrderProcessRepository;
        readonly MillenniumProductImageIntegrationRepository _millenniumProductImageIntegrationRepository;
        readonly MillenniumListProductManualProcessRepository _millenniumListProductManualProcessRepository;
        readonly MillenniumImageIntegrationRepository _millenniumImageIntegrationRepository;
        readonly IMethodPaymentRepository _methodPaymentRepository;
                                                ...
                                                CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    _logger.Warning("MillenniumService - Error in ListProduct | {0} - {1}", productList.Error.Message, Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), new MillenniumApiListProductsRequest
                    {
                        ProductId = id,
                        ListaPreco = true
                    }, millenniumData));
                ...
                if (products.Any())
                {
                    ...
                    foreach (var product in products)
                    {
                        if (product.tipo_prod == "AC")
                        {
                            ...
                            {
                                _logger.Warning($"MillenniumService - Error in ListProduct | {stockList.Error.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), new MillenniumApiListStocksRequest
                                {
                                    ProductId = id
                                }, millenniumData));
                                                                                    ...
                                                                                    CancellationToken cancellationToken)
        {
            ...
            foreach (var componentesSkuKit in componentesKit)
            {
                ...
                {
                    _logger.Warning($"MillenniumService - Error in GetStockkit | {getStock.Error.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), new MillenniumApiListStocksRequest
                    {
                        ProductId = id
                    }, millenniumData));
            ...
            if (millenniumData.EnableSaveProcessIntegrations)
            {
                ...
                catch (Exception ex)
                {
                    _logger.Error(ex, $"Problemas ao salvar processo de integração de produto | Error.mensagem: {ex.Message}",
                        Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), process, millenniumData,
                        ...
                        try
                        {
                            ...
                            if (millenniumData.EnableSaveIntegrationInformations)
                            {
                                ...
                                catch (Exception ex)
                                {
                                    _logger.Warning("Erro ao salvar integração | MillenniumService:503 | {0}",
                                        Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), integration, millenniumData,
                            ...
                            else if (millenniumData.EnableProductKit)
                            {
                                var listProductMessage = new ShopifyListERPFullProductMessage
                                {
                                    ...
                                    IntegrationId = millenniumData.EnableSaveIntegrationInformations ? integration.Id : null
                                };
                            ...
                            else if (millenniumData.HasZeroedPriceCase)
                            {
                                ...
                                var priceMessage = new ShopifyUpdatePriceMessage
                                {
                                    ...
                                    Value = new Product.SkuPrice
                                    {
                                        ...
                                        Price = pivotValue,
                                        CompareAtPrice = compareAtPrice > pivotValue ? compareAtPrice : null
                                    },
                                    IntegrationId = millenniumData.EnableSaveIntegrationInformations ? integration.Id : null
                                };
                            ...
                            else
                            {
                                ...
                                var priceMessage = new ShopifyUpdatePriceMessage
                                {
                                    ...
                                    Value = new Product.SkuPrice
                                    {
                                        ...
                                        CompareAtPrice = compareAtPrice > price.preco1.Value ? compareAtPrice : null
                                    },
                                    IntegrationId = millenniumData.EnableSaveIntegrationInformations ? integration.Id : null
                                };
                                var serviceBusMessage = new ServiceBusMessage(priceMessage);
                                    ...
                                    CancellationToken cancellationToken = default)
        {
            ...
            if (stockList.Result == Result.Error)
            {
                _logger.Warning($"MillenniumService - ListNewStockMto | {stockList.Error.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), new MillenniumApiListStockMtoRequest
                {
                    EstrategiaProducao = "2",
                    Filiais = new List<string> { "3" },
                    Top = 1
            ...
            else
            {
                ...
                Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), new MillenniumApiListStockMtoRequest
                {
                    EstrategiaProducao = "2",
                    Filiais = new List<string> { "3" },
                    Top = 1
                                                           ...
                                                           MilenniumApiCreateOrderPaymentDataRequest milenniumApiCreateOrderPaymentDataRequest)
        {
            ...
            var createOrder = new MillenniumApiCreateOrderRequest
            {
                ...
                v_acerto = adjustmentValue == 0 ? null : adjustmentValue,
                acerto = adjustmentValue == 0 ? null : adjustmentValue / message.Subtotal * 100,
        ...
        ReturnMessage RegisterExceptionOrderList(MillenniumData millenniumData, ShopifySendOrderToERPMessage message, MillenniumUpdateOrderProcess process, ReturnMessage<MillenniumApiListOrdersResult> orderList)
        {
            ...
            Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, millenniumData));
        ...
        public async Task<ReturnMessage> ListNewOrders(MillenniumData millenniumData, QueueClient shopifyUpdateOrderStatusQueueClient, CancellationToken cancellationToken)
        {
            ...
            if (millenniumData.Retry)
            {
                ...
                if (retry.Result == Result.Error)
                {
                    _logger.Warning($"MillenniumService - Error in ListNewOrders | {retry.Error.Message}",
                        Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), new MillenniumApiListOrdersRequest
                        {
                            DataInicial = DateTime.UtcNow.AddDays(-3).ToString("yyyy-MM-dd"),
                            DataFinal = DateTime.UtcNow.ToString("yyyy-MM-dd"),
                            Top = 1
            ...
            if (orderList.Result == Result.Error)
            {
                _logger.Warning("MillenniumService - Error in ListNewOrders | {0}",
                    Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(),
                    new MillenniumApiListOrdersRequest
                    {
                        TransId = transId.Value,
                        Top = millenniumData.NumberOfItensPerAPIQuery > 0 ? millenniumData.NumberOfItensPerAPIQuery : 25
            ...
            if (orderList.Data.value.Any())
            {
                ...
                if (response.Result == Result.Error)
                {
                    _logger.Warning($"MillenniumService - Error in ListOrder | {response.Error.Message}",
                        Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), order, millenniumData));
                    return new ReturnMessage { Result = Result.Error, Error = response.Error };
                }
                                   ...
                                   CancellationToken cancellationToken = default)
        {
            ...
            else
            {
                _logger.Warning($"MillenniumService - Error in GetPriceProduct | MillenniumApiListPricesResult.value is empty",
                    Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), new MillenniumApiListPricesRequest
                    {
                        ProductId = Convert.ToInt32(productId),
                    }, millenniumData));
                                    ...
                                    CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (productList.Result == Result.Error)
                {
                    _logger.Warning($"MillenniumService - Error in ProcessProductImage | {productList.Error.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), message, millenniumData));
                    return new ReturnMessage { Result = Result.Error, Error = productList.Error };
                }
                ...
                else
                {
                    ...
                    foreach (var product in productList.Data.value.OrderBy(x => x.ordem))
                    {
                        ...
                        {
                            _logger.Warning($"MillenniumService - Error in ProcessProductImage | {imageList.Error.Message}", Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), new MillenniumApiBuscaFotoRequest
                            {
                                IdFoto = product.idfoto
                            }, millenniumData));
                ...
                if (millenniumData.EnableSaveIntegrationInformations)
                {
                    ...
                    catch (Exception exx)
                    {
                        _logger.Error($"Problemas ao salvar integração de imagem | Error.mensagem: {exx.Message}",
                            Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), imageIntegration, millenniumData,
                ...
                if (sku.Status)
                {
                    ...
                    if (price == null || price.preco1 == null)
                    {
                        _logger.Warning("MillenniumService - Error in GetPartialProductMessage | Product without price | Produto : {0} sku {1} | {2}",
                            productInfo.ExternalId, sku.OriginalSku, Extensions.LoggingExtensions.FromService(Extensions.LoggingExtensions.GetCurrentMethod(), productInfo, millenniumData));
                    }
                    else
                    {
                        sku.Price = PriceFill(price, millenniumData, sku);
